...
#define JOYSTICK_VERIFICATION_PASSWORD_OK 0
#define JOYSTICK_VERIFICATION_PASSWORD_NOK -1
#define JOYSTICK_VERIFICATION_PASSWORD_VERIFICATION_NOT_FINISHED -2
